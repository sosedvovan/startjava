...
public abstract class AbstractStorageTest {
     ...
     *     }
     *
     *  Это исп. в след. случае: если бы конструктор Resume бросал чекед эксепшн, то при создании
     *  объекта--  new Resume(UUID_1) -- в поле класса мы не можем его обработать,
     *  а в статическом блоке мы можем -- RESUME_1 = new Resume(UUID_1);  -- взять в блок try-catch
     *
