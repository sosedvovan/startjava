...
//например:   ------   public class ListStorage extends AbstractStorage<Integer> ------

//и далее во всех классах-наследниках Object в аргументах методов заменяем на <Integer> или <String> или <Resume>
...
public abstract class AbstractStorage<SK> implements Storage {//<SK> это searchKey имеем ввиду
    //методы size() и clear() getAll() мы сюда не можем скопировать из
    //AbstractArrayStorage тк для Мапа они будут другие (их реализацию пробросим дочкам)
    ...
    //-----------------------------------------------------------------------------------
    //БЛОК СЛУЖЕБНЫХ(для убирания дублирования кода) МЕТОДОВ:
