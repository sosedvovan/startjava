...
public class StorageException extends RuntimeException{
    ...
    */
    ...
    /**конструктор для 2-х аргументов, выбрасывается в сторадже File*/
    public StorageException(String message, Exception e) {
        this(message, null, e);//делегировали в конструктор с 3-я аргументами
                              //пробросив и uuid = null, тк uuid final
