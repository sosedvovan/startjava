...
<section>
<form method="post" action="resume" enctype="application/x-www-form-urlcoded" >
...
<c:choose>
    ...
    <input type="text" name="${tape}" saze=75 values="<%=section%>">
    </c:when>
        ...
        <c:forEach var="org" items="<%=((OrganizationSection)section).getOrganizations()%>" varStatus="counter">
            ...
            <div style="margin-left: 30px">
                <c:forEach var="pos" items="${org.positions}">
                    ...
                    <dl>
                        <dt>Описание:</dt>
                        <dd><textarea name="${type}${counter.index}description" rows=5 cols=75>${pos.description}</textarea></dd>
                    </dl>
                </c:forEach>
            </div>
        </c:forEach>
